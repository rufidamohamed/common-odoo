...
class SendSMS(models.Model):
    ...
    def send_sms(self, record_id, template_id, sms_to ):
        
        sms_rendered_content = self.env['send.sms.template'].render_template(template_id.sms_html, template_id.model_id.model, record_id)
        #rendered_sms_to = self.env['send.sms.template'].render_template(sms_to, template_id.model_id.model, record_id)
        self.send_sms_link(sms_rendered_content,sms_to,record_id,template_id.model_id.model,template_id.gateway_id)
